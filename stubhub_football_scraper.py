...
async def scrape_stubhub_football():
    tickets_data = []
    events_list = []
    async with async_playwright() as pw:
        ...
        url = f'https://www.stubhub.com/pittsburgh-steelers-tickets/performer/5742?restPage=1'
        await page.goto(url)
...
#    df = scrape_stubhub_football()
#    df.to_csv('stubhub_football_tickets_12_5.csv', index=False)